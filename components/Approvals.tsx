...
export const Approvals: React.FC<ApprovalsProps> = ({ 
  ...
  const handleAddComment = async (batchId: string, itemId: string, text: string, pageNumber?: number) => {
    const batch = batches.find(b => b.id === batchId);
    const item = batch?.items.find(i => i.id === itemId);
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {(currentUser.role === 'ADMIN' || currentUser.role === 'MANAGER' || currentUser.role === 'EMPLOYEE' || currentUser.role === 'COMMERCIAL' || currentUser.role === 'FREELANCER') && (
            <button 
